...
- 결과를 클립보드에 복사하여 Instructions에 붙여 넣음
  결과 복사     
  ![](images/2025-03-26-23-16-38.png)  
  ...
  CTRL-V로 내용을 붙여넣고 '지침저장'버튼 클릭  
  ![](images/2025-03-26-23-19-13.png)

- Knowledge에 협업에 필요한 자료를 업로드   
  좌측에 있는 파일 목록 중 아래 파일을 다운로드 하고 Knowledge에 업로드      
